        ...
        <div class="h-19">
            ...
            <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap dark:text-white text-slate-700"
                ...
                <img src="{{ asset('assets/img/logo-ct-dark.png') }}"
                    ...
                    alt="main_logo" />
                <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">By Bou</span>
            </a>
        </div>
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-white dark:opacity-80 py-2.7 text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i
                                class="relative top-0 leading-normal text-orange-500 text-size-sm ni ni-single-copy-04"></i>
                        </div>
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    ...
                    <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                        ...
                        <li class="flex items-center pl-4 xl:hidden">
                            <a href="javascript:;"
                                class="block p-0 text-white transition-all ease-nav-brand text-size-sm"
                                sidenav-trigger>
            ...
            <div class="flex flex-wrap mt-6 -mx-3">
                ...
                <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                    <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                        ...
                        <!-- Control buttons -->
                        <button btn-next
                            class="absolute z-10 w-10 h-10 p-2 text-white border-none opacity-50 cursor-pointer text-size-lg hover:opacity-100 far fa-chevron-right active:scale-110 top-6 right-4"></button>
                        <button btn-prev
                            class="absolute z-10 w-10 h-10 p-2 text-white border-none opacity-50 cursor-pointer text-size-lg hover:opacity-100 far fa-chevron-left active:scale-110 top-6 right-16"></button>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="flex items-center px-2 py-1">
                                                ...
                                                <div class="ml-6">
                                                    <p
                                                        ...
                                                        Country:</p>
                                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">United
                                                        States</h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Value:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">$230,900
                                                </h6>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td
                                            ...
                                            <div class="text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Value:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">$440,000
                                                </h6>
                                            </div>
                                        </td>
                                        <td
                                            ...
                                            <div class="flex-1 text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Bounce:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">40.22%
                                                </h6>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="flex items-center px-2 py-1">
                                                ...
                                                <div class="ml-6">
                                                    <p
                                                        class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                        Country:</p>
                                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Great
                                                        Britain</h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Value:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">$190,700
                                                </h6>
                                            </div>
                                        </td>
                                        <td
                                            ...
                                            <div class="flex-1 text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Bounce:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">23.44%
                                                </h6>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="flex items-center px-2 py-1">
                                                ...
                                                <div class="ml-6">
                                                    <p
                                                        class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                        Country:</p>
                                                    <h6 class="mb-0 leading-normal text-size-sm dark:text-white">Brasil
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="p-2 align-middle bg-transparent border-0 whitespace-nowrap">
                                            <div class="text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Value:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">$143,960
                                                </h6>
                                            </div>
                                        </td>
                                        <td
                                            class="p-2 leading-normal align-middle bg-transparent border-0 text-size-sm whitespace-nowrap">
                                            <div class="flex-1 text-center">
                                                <p
                                                    class="mb-0 font-semibold leading-tight dark:text-white text-size-xs dark:opacity-60">
                                                    Bounce:</p>
                                                <h6 class="mb-0 leading-normal text-size-sm dark:text-white">32.14%
                                                </h6>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <li
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <i
                                                class="text-white ni ni-mobile-button relative top-0.75 text-size-xxs"></i>
                                        </div>
                                        <div class="flex flex-col">
                                            <h6
                                                class="mb-1 leading-normal text-size-sm text-slate-700 dark:text-white">
                                                Devices</h6>
                                            <span class="leading-tight dark:text-white/80 text-size-xs">250 in stock,
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex flex-col">
                                            <h6
                                                class="mb-1 leading-normal text-size-sm text-slate-700 dark:text-white">
                                                Tickets</h6>
                                            <span class="leading-tight dark:text-white/80 text-size-xs">123 closed,
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex flex-col">
                                            <h6
                                                class="mb-1 leading-normal text-size-sm text-slate-700 dark:text-white">
                                                Error logs</h6>
                                            <span class="leading-tight dark:text-white/80 text-size-xs">1 is active,
            ...
            <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
                ...
                <a href="javascript:void(0)">
                    <div class="my-2 text-left" sidenav-colors>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-blue-500 to-violet-500 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-slate-700 text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                            active-color data-color="blue" onclick="sidebarColor(this)"></span>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                            data-color="gray" onclick="sidebarColor(this)"></span>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-blue-700 to-cyan-500 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                            data-color="cyan" onclick="sidebarColor(this)"></span>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-emerald-500 to-teal-400 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                            data-color="emerald" onclick="sidebarColor(this)"></span>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-orange-500 to-yellow-500 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                            data-color="orange" onclick="sidebarColor(this)"></span>
                        <span
                            class="py-2.2-em text-size-xs px-3.6-em rounded-circle h-5.6 mr-1.25 w-5.6 ease-in-out bg-gradient-to-tl from-red-600 to-orange-600 relative inline-block cursor-pointer whitespace-nowrap border border-solid border-white text-center align-baseline font-bold uppercase leading-none text-white transition-all duration-200 hover:border-slate-700"
                ...
                <div class="mt-4">
                    ...
                    <p class="leading-normal dark:text-white dark:opacity-80 text-size-sm">Choose between 2 different
                        sidenav types.</p>
                </div>
                <div class="flex">
                ...
                <p class="block mt-2 leading-normal dark:text-white dark:opacity-80 text-size-sm xl:hidden">You can
